    ...
    _.extend( media.view.Selection.prototype, {
        ...
        selectAll: function( event ) {
            ...
            if ( library.hasMore() ) {
                ...
                spinner.show();
                emlFullscreenSpinnerStart( 'Selecting...' );
                loadAll();
            }
        ...
        deleteSelected: function( event ) {
            ...
            var data = {},
                ...
                bulk_sidebar = content.sidebar.get( 'bulk-edit' ),
            ...
            if ( media.view.settings.mediaTrash ) {
                ...
                emlConfirmDialog( 'Delete Selected', 'You are about to permanently delete all selected items.', 'Delete', 'Cancel', 'button button-primary' )
                .done( function() {
                    doDeleteSelected();
                })
                .fail(function() {
            ...
            function doDeleteSelected() {
                ...
                spinner.show();
                emlFullscreenSpinnerStart( 'Deleting...' );
                if ( ! _.isUndefined( bulk_sidebar ) ) {
                    bulk_sidebar.$el.find('input').prop('disabled', true);
                }
                ...
                selection.bulkDelete( data ).always( function() {
                    ...
                    emlFullscreenSpinnerStop();
                    if ( ! _.isUndefined( bulk_sidebar ) ) {
                        bulk_sidebar.$el.find('input').prop('disabled', false);
                    }
